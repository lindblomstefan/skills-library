...
- The installable `.codex/skills/skill-library/SKILL.md` must stay short and sequenced. `npm test` fails if it grows beyond 90 lines or reintroduces repo-consent-first wording.
